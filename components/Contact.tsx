...
const Contact = () => {
  ...
  return (
    <motion.div
      style={{ y }}
      ref={contactRef}
      className="overflow-hidden relative z-0 flex flex-col h-[100vh] justify-between px-20 w-full   items-start content-start bg-[#141516] "
    >
      <div className="pt-52 w-full Top h-full text-6xl font-thin text-white">
        Contacts
      </div>
